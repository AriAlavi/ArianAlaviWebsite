...
"""
Django settings for ArianAlaviWebsite project.
...
ROOT_URLCONF = 'ArianAlaviWebsite.urls'
...
WSGI_APPLICATION = 'ArianAlaviWebsite.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['https://arianalavi.com']
